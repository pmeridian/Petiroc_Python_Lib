...
if (not args.timing_mode):
        ...
        PETIROC_PetirocCfg0_CONFIG("",handle)
else:
        print("Timing (non latched) mode. Energy measurement unavailable only ToT")
        #Non Latched (mask all but ch16)
        PETIROC_PetirocCfg0_CONFIG("",handle)
time.sleep(1)
...
if (CPACK_CP_0_START(handle) == True):
	...
	if (Frame_Status >0):
		while( int(ReadDataNumber)/FrameSize < N_Total_Events):
			try:
				...
				print("Event Id: %d(%d)/%d"%(ReadDataNumber/FrameSize,counts,N_Total_Events), end='\r',flush=True)
